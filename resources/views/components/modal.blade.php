    ...
    <form id="modal-form" method="POST" class="flex flex-col pt-6">
        ...
        <div class="grid gap-4 p-6 pt-0 max-h-[60vh] overflow-y-auto">
            ...
            <div class="grid gap-2">
                ...
                <x-text-input type="text" id="job_title" name="job_title" placeholder="e.g. Frontend Engineer" required />
            </div>
            ...
            <div class="grid gap-2">
                ...
                <textarea id="job_description" name="job_description" rows="4" required
                    class="input h-auto resize-none" placeholder="Paste the full job description..."></textarea>
            </div>
            <div class="grid gap-2">
                <x-input-label for="cover_letter_text" :value="__('Cover Letter')" />
                <textarea id="cover_letter_text" name="cover_letter_text" rows="3"
                    class="input h-auto resize-none" placeholder="Optional cover letter..."></textarea>
            </div>
            <div class="grid gap-2">
            ...
            <div class="grid gap-2">
                ...
                <textarea id="email_body" name="email_body" rows="3"
                    class="input h-auto resize-none" placeholder="Email content..."></textarea>
            </div>
            <div class="grid gap-2">
                <x-input-label for="notes" :value="__('Notes')" />
                <textarea id="notes" name="notes" rows="2"
                    class="input h-auto resize-none" placeholder="Any additional notes..."></textarea>
            </div>
        </div>
